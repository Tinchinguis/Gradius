...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/data/LevelOgmo.oel", __ASSET__assets_data_levelogmo_oel);
		type.set ("assets/data/LevelOgmo.oel", AssetType.TEXT);
		...
		className.set ("assets/images/starswall.jpg", __ASSET__assets_images_starswall_jpg);
		type.set ("assets/images/starswall.jpg", AssetType.IMAGE);
		className.set ("assets/images/xd.png", __ASSET__assets_images_xd_png);
		type.set ("assets/images/xd.png", AssetType.IMAGE);
		...
		type.set (id, AssetType.IMAGE);
		id = "assets/images/starswall.jpg";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/xd.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_data_levelogmo_oel extends null { }
...
@:keep @:bind #if display private #end class __ASSET__assets_images_starswall_jpg extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_xd_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:file("assets/data/LevelOgmo.oel") #if display private #end class __ASSET__assets_data_levelogmo_oel extends lime.utils.Bytes {}
...
@:image("assets/images/starswall.jpg") #if display private #end class __ASSET__assets_images_starswall_jpg extends lime.graphics.Image {}
@:image("assets/images/xd.png") #if display private #end class __ASSET__assets_images_xd_png extends lime.graphics.Image {}
